...
#     writer.writeheader()
#     writer.writerow({"name": "Олег Олегов", "age": 23, "speciality": "Історія"})
#     writer.writerow({"name": "Анна Сергіївна", "age": 22, "speciality": "Біологія"})

# # Читання з CSV файлу в словники
# with open("students.csv", newline="", encoding="utf-8") as csvfile:
#     reader = csv.DictReader(csvfile)
#     for row in reader:
#         print(row["name"], row["age"], row["speciality"])
